...
import com.seiko.immersionbar.sample.activity.FragmentOneActivity
 ...
 * @date 2017/5/12
 */
class HomeOneFragment : BaseImmersionFragment() {
    ...
    lateinit var mLlScan: LinearLayout
    ...
    override fun setListener() {
        ...
        mLlScan.setOnClickListener {
            startActivity(Intent(activity, FragmentOneActivity::class.java))
        }
    }
